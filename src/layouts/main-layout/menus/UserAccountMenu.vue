<template>
  ...
  >
      ...
      <div class="menu-content d-flex align-items-center px-3">
        ...
        <div class="d-flex flex-column">
          <div class="fw-bold d-flex align-items-center fs-5">
            {{$oidc.userProfile.given_name}} {{$oidc.userProfile.family_name}}
            
          </div>
          <a href="#" class="fw-semobold text-info text-hover-primary fs-7"
            >{{$oidc.userProfile.email}}</a
          >
        </div>
        <!--end::Username-->
      </div>
    ...
    <div class="menu-item px-5">
      <a href="https://sso-europcar.codebase.cl" class="menu-link px-5" target="_blank">
