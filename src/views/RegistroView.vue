...
<section class="login-section">
    <div class="login-content align-items-start">
      ...
      <div class="login-container">
        <p class="new-user">
          Registra una nueva cuenta en SoapBomberos:
        </p>
        <Form
        ...
        <p class="new-user text-center">
          Accede directamente usando:
        </p>
        <div class="social-buttons">
          ...
          <!--<button type="button" class="btn-social facebook">
            <i class="fab fa-facebook-f"></i><em class="btn-text">Continuar con Facebook</em>
          </button>-->
