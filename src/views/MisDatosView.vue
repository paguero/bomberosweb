              ...
              <div class="divider"></div>
                <Form
                    id="kt_reservation_form"
                        novalidate="novalidate"
                        @submit="saveChangePassword()"
                        :validation-schema="updatepasswordValidator"
                        class="form">
                        <div class="d-flex flex-column p-5 w-80">
                        </div>
                        ...
                        <div class="d-flex flex-row p-5 w-100 align-items-center justify-content-start">
                            <div class="px-3 text-left">
                                <button class="btn btn-primary">Actualizar contraseña
                                </button>
                            </div>
...
const registerDetails = ref<UserLogin>({
    identificationNumber:currentUser.value?.profile?.identification_number,
    country: 'CL',
    ...
    const saveChangePassword = () => {
        store.updatePassword(registerDetails.value)
          .then(() => {
            Swal.fire({
          ...
          .catch((e) => {
            console.log(Object.values(store.errors));
    ...
    const saveChanges = () => {
        loading.value = true;
        store.update(registerDetails.value)
          .then(() => {
            Swal.fire({
