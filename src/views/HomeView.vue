    ...
    <div class="slider-container">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item slide0 active">
            <div class="content-slider slide flex-column align-items-start justify-content-center">
              <h2 class="text-blue">Compra tu <br>SOAP Bomberos 🚒<br>
              y Mercado Pago se pone con $5.000 🤑</h2>
              <a href="/compra-soap" class="benefit-button">Conoce este beneficio <span>→</span></a>
            </div>
          </div>
...
.text-blue {color:#001f54!important;}
.div-asistencias {
