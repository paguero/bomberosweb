...
<main style="
    width: 100%;height:100%;background-image: url('/media/misc/c174abe7c7903ca1e3e5de4003cbaa87.png');">
    ...
    <div class="container">
      ...
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
          ...
          <!-- Title -->
          <h1 class="mb-0 display-6">Gracias por ser un 
            <span class="position-relative">aporte
              <!-- SVG START -->
          ...
          <!-- Content -->
          <p class="my-4 lead"><b>AseguraOnline</b> Quiere agradecer tu apoyo a Bomberos de Chile y te regala 3 meses de asistencias gratis</p>
          ...
          <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
            <!-- Button -->
            <button type="button" @click="cerrarMensajeComprar" class="btn btn-lg btn-danger-soft active me-2 mb-4 mb-sm-0">Reclamar mis asistencias Gratis</button>
            <!-- Video button -->
            <div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
              <button type="button" @click="cerrarMensaje" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">No por ahora.</button>
            </div>
          </div>
        </div>
        <!-- Left content END -->
        ...
        <div class="col-lg-7 col-xl-6 text-center position-relative">
          ...
          <!-- Icon logos START -->
          <div class="p-2 rounded-3 position-absolute top-50 start-0 translate-middle-y mt-n7 d-none d-sm-block">
            <img class="_7_i_XA" crossorigin="anonymous" src="/media/misc/asegura.webp" draggable="false">
          </div>
          <div class="p-2 rounded-3 position-absolute top-0 end-0 me-5">
            <img class="_7_i_XA" crossorigin="anonymous" src="/media/misc/heart-icon.webp" draggable="false">
          </div>
          <div class="p-2 rounded-3 position-absolute top-50 end-0 translate-middle-y mt-5 ms-5 d-none d-lg-block z-index-9">
            <img class="_7_i_XA" crossorigin="anonymous" src="/media/misc/insg.webp" draggable="false">
          </div>
          <!-- Icon logos END -->
          <!-- Image -->
          <div class="position-relative ms-sm-4">
            <img src="/media/img/2a2df374-5606-4bb3-9266-228719dbd456.png" alt="">
          </div>
        </div>
        <!-- Right content END -->
      </div>
...
const authName = 'main';
const nameSlug =authName;
export default defineComponent({
  name: "login-reserva-incial",
  components: {
  ...
  setup(props, ctx) {
    ...
    const cerrarMensaje = () =>{
      ...
      ctx.emit("cerrarAsistencias",false); 
    };
    const cerrarMensajeComprar = () =>{
      ctx.emit("cerrarAsistencias",true); 
    };
    
    
    return {
      cerrarMensaje,
      cerrarMensajeComprar
    };
  },
});
</script>
...
.btn.active:hover {
      color: #fff !important;
      background-color: #aa0c1f !important;
      border-color: #d6293e !important;
}
